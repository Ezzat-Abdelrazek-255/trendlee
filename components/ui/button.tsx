...
const Button = ({
  ...
  const styles: {
    ...
    primary:
      "relative z-0 rounded-full  px-[2.4rem] py-[1.6rem] text-white after:absolute after:inset-0 after:z-hidden after:bg-primary/50 after:blur-[1.2rem] after:content-[''] font-medium bg-gradient-to-b from-primary to-primary-dark/80 backdrop-blur-sm",
    outline:
